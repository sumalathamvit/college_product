...
function StudentPerformanceInternal() {
  //#region Const
  ...
  const handleMark = async () => {
    ...
    if (
      data.some(
        (item) =>
          parseInt(item.mark) +
            parseInt(item.assignmentMark ? item.assignmentMark : 0) >
    ...
    try {
      ...
      let internalMarks = [];
      if (retest) {
        internalMarks = data.map(
          ({ studentID, mark, assignmentMark, absent, reTest }) => ({
            studentID,
            mark: mark === null ? 0 : mark,
            assignmentMark: assignmentMark === null ? 0 : assignmentMark,
            reTest: 1,
          })
        );
      } else {
                                    ...
                                    <TextField
                                      ...
                                      onChange={(e) => {
                                        if (
                                          ...
                                          data[
                                            index
                                          ].assignmentMarkError = true;
                                          // setMarkError(true);
                                        } else {
                                          data[index].assignmentMark = e.target
                                            .value
                                            ? parseInt(e.target.value)
                                            : null;
                                          data[
                                            index
                                          ].assignmentMarkError = false;
                                        }
                                        setData([...data]);
                                        setUnSavedChanges(true);
                                      }}
                                      error={
                                        data[index].assignmentMarkError
                                    ...
                                    <TextField
                                      ...
                                      onChange={(e) => {
                                        if (
                                          ...
                                          retestData[index].assignmentMark = e
                                            .target.value
                                            ? parseInt(e.target.value)
                                            : null;
                                          retestData[
...
export default StudentPerformanceInternal;
