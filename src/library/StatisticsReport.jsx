...
import { statisticsReportList } from "../component/common/CommonArray";
...
function StatisticsReport() {
  ...
  const [reportType, setReportType] = useState(statisticsReportList[0]);
  ...
  const handleCSVData = async (type) => {
    try {
      ...
      if (reportType.value == "list_of_books_report") {
      ...
      if (reportType.value == "library_issue_return_statistic_report") {
        var csvData = [
          [
            "No.",
            "Staff Issue",
                    ...
                    <>
                      <div className="row col-lg-8 mt-4 border p-3">
                        ...
                        <div className="table-responsive mt-4 p-0">
                          ...
                          {reportType.value == "list_of_books_report" ? (
                            <table
                          ...
                          {reportType.value ==
                          "library_issue_return_statistic_report" ? (
                            <table
                              className="table report-table table-bordered"
                              id="pdf-table"
                            >
                              <thead>
                                <tr>
                                  <th width="1%">No.</th>
                                  <th width="5%">Staff Issue</th>
                                  <th width="5%">Staff Return</th>
                                  <th width="5%">Student Issue</th>
                                  <th width="5%">Student Return</th>
                                  <th width="3%">Total</th>
                                </tr>
                              </thead>
                              <tbody>
                                {data.length == 0 ? (
                                  ...
                                  data.map((item, index) => {
                                    return (
                                      <tr key={index}>
                                        <td>{index + 1}</td>
                                        <td>{item.staff_issued}</td>
                                        <td>{item.staff_returned}</td>
                                        <td>{item.student_issued}</td>
                                        <td>{item.student_returned}</td>
                                        <td>
                                          {item.staff_issued +
                                            item.staff_returned +
                                            item.student_returned +
