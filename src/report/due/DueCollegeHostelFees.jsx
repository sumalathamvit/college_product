...
function DueCollegeHostelFees() {
  ...
  const handleDueAbstractCSVData = async (values, report) => {
    ...
    if (report === 1) {
      ...
      let columnWidth = [5, 15, 30, 20, 20, 10];
  ...
  const handleShow = async (values, showAll = 0, report = 0) => {
    ...
    try {
      ...
      const dueCollegeHostelRes = await StudentApi.getDueCollegeHostel(
...
export default DueCollegeHostelFees;
