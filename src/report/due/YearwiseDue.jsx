  ...
  const handleCSVData34 = async (report) => {
    if (report == 1) {
      ...
      data.map((student, index) => {
        const rowArray = [
          index + 1,
          ...headerList.map((item) => student[item]),
        ];
      ...
      preFunction.downloadCSV(csvData, RENAME?.year + " wise Due.csv");
    }
  };
