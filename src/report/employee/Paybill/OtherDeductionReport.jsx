...
function OtherDeductionReport() {
  ...
  const handleCsvExport = async (values, type) => {
    ...
    if (type === 1) {
      ...
      let head = [
        [
          ...
          { content: "Deduction", styles: boldStyle },
          {
            content: "Amount (Rs.)",
    ...
    preFunction.downloadCSV(csvData, "Other Deduction Report");
    return;
  };
  ...
  const handleShow = async (values, report) => {
    ...
    try {
      setLoad(true);
      const getOtherDeductionReportRes =
        await employeeapi.getOtherDeductionReport(
      ...
      console.log("getOtherDeductionReportRes---", getOtherDeductionReportRes);
      setShowRes(true);
      setData(
        getOtherDeductionReportRes.data.message.data.other_deduction_report
      );
...
export default OtherDeductionReport;
