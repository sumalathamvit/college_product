...
function BookDetailAccessNumberWise() {
  ...
  const handleCSVData = async (values, type) => {
    try {
      console.log("csvDataList-----", data, values, formikRef.current.values);
      ...
      if (type == 1) {
        ...
        let columnWidth = [4, 6, 28, 16, 19, 7, 5, 8, 7];
        ...
        preFunction.downloadCSV(csvData, "Book Detail By AccessNo.");
      }
      setLoad(false);
    } catch (error) {
      console.log(error);
...
export default BookDetailAccessNumberWise;
