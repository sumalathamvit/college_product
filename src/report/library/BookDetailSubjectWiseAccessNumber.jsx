...
function BookDetailSubjectWiseAccessNumber() {
  ...
  const handleCSVData = async (values, type) => {
    try {
      ...
      if (type == 1) {
        ...
        let columnWidth = [5, 10, 34, 24, 10, 7, 10];
        ...
        preFunction.generatePDFContent(
          ...
          "Book Detail Subject Wise AccessNo.",
          pdfHeadToPass,
          pdfDataToPass,
          colWidthToPass
          // "Landcape"
        ...
        preFunction.downloadCSV(csvData, "Book Detail Subject Wise AccessNo.");
      }
      setLoad(false);
    } catch (error) {
      console.log(error);
...
export default BookDetailSubjectWiseAccessNumber;
