...
function BookDetailTitleSubjectWise() {
    ...
    try {
      ...
      if (type == 1) {
        ...
        preFunction.generatePDFContent(
          ...
          "Book Detail Title Subject Wise",
          pdfHeadToPass,
          pdfDataToPass,
          colWidthToPass
          // "Landcape"
        ...
        preFunction.downloadCSV(csvData, "Book Detail Title SubjectWise");
      }
      setLoad(false);
    } catch (error) {
      console.log(error);
...
export default BookDetailTitleSubjectWise;
