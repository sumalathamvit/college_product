...
function DepartmentBookByTitleWise() {
  ...
  const handleCSVData = async (values, type) => {
    try {
      ...
      if (type == 1) {
        ...
        let columnWidth = [3, 36, 20, 26, 7, 5, 3];
        ...
        preFunction.generatePDFContent(
          ...
          "Department Book Detail Title Wise Qty",
          pdfHeadToPass,
          pdfDataToPass,
          colWidthToPass,
          "Landcape"
        ...
        var csvData = [
          ["No.", "Title", "Author", "Subject", "YOP", "Edition", "Qty"],
        ];
        values.map((item, index) => {
          if (
            index === 0 ||
...
export default DepartmentBookByTitleWise;
