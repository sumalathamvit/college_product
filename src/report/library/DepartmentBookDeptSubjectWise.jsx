...
function DepartmentBookDeptSubjectWise() {
    ...
    try {
      ...
      if (type == 1) {
        ...
        preFunction.generatePDFContent(
          ...
          "Department Book Detail Subject Wise Qty",
          pdfHeadToPass,
          pdfDataToPass,
          colWidthToPass
          // "Landcape"
...
export default DepartmentBookDeptSubjectWise;
