...
function IssueReturnStatistics() {
    ...
    try {
      ...
      if (type == 1) {
        ...
        preFunction.generatePDF(
          ...
          "Library Issue / Return Statistics",
          csvData
        );
      } else {
        preFunction.downloadCSV(csvData, "Library Issue / Return Statistics");
      }
      setLoad(false);
    } catch (error) {
      console.log(error);
...
export default IssueReturnStatistics;
