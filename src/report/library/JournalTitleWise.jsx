...
function JournalTitleWise() {
  ...
  const handleCSVData = async (values, type) => {
    ...
    var csvData = [["No.", "Journal Name", "Frequency", "Author Type", "Year"]];
    ...
    if (type == 1) {
      ...
      preFunction.downloadCSV(csvData, "Journal Title Wise.csv");
    }
...
export default JournalTitleWise;
