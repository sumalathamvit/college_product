...
function OnHandBookSubjectWiseQty() {
  let totalQty = 0;
    ...
    try {
      ...
      if (type == 1) {
        preFunction.generatePDF(
          ...
          "On Hand Book Details Subject Wise Quantity",
          pdfData,
          columnWidth
        );
      } else {
        preFunction.downloadCSV(
          csvData,
          "On Hand Book Details Subject Wise Quantity.csv"
        );
      }
      setLoad(false);
    } catch (error) {
...
export default OnHandBookSubjectWiseQty;
