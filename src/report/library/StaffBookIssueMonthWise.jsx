...
function StaffBookIssueMonthWise() {
      ...
      if (type == 1) {
        ...
        let head1 = [
          [
            ...
            { content: "Staff No.", styles: topLineStyle },
            { content: "Staff Name", styles: topLineStyle },
        ...
        values.map((item1, index1) => {
          ...
          item1.books.map((item, index) => {
            ...
            csvData.push([
              ...
              item.edition,
              item.member_number,
              preFunction.capitalizeFirstLowerOther(item.member_name),
        ...
        preFunction.downloadCSV(csvData, "Staff Book Issue Month Wise");
      }
      setLoad(false);
    } catch (error) {
      console.log(error);
...
export default StaffBookIssueMonthWise;
