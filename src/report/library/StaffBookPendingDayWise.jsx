...
function StaffBookPendingDayWise() {
  ...
  const handleCSVData = async (values, type) => {
    try {
      ...
      if (type == 1) {
        ...
        preFunction.downloadCSV(csvData, "Staff Book Pending Day Wise");
      }
      setLoad(false);
    } catch (error) {
      console.log(error);
...
export default StaffBookPendingDayWise;
