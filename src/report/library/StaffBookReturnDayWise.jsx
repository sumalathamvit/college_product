...
function StaffBookReturnDayWise() {
  ...
  const handleCSVData = async (values, type) => {
    try {
      if (type == 1) {
        ...
        preFunction.downloadCSV(csvData, "Staff Book Return Day Wise");
      }
      setLoad(false);
    } catch (error) {
      console.log(error);
...
export default StaffBookReturnDayWise;
