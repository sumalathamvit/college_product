...
function StaffBookReturnMonthWise() {
  ...
  const handleCSVData = async (values, type) => {
    try {
      ...
      if (type == 1) {
        ...
        preFunction.downloadCSV(csvData, "Staff Book Return Month Wise");
      }
      setLoad(false);
    } catch (error) {
      console.log(error);
...
export default StaffBookReturnMonthWise;
