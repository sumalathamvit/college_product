...
function StudentBookIssueDayWise() {
  ...
  const handleCSVData = async (values, type) => {
    ...
    try {
      if (type == 1) {
        ...
        preFunction.downloadCSV(csvData, "Student Book Issue Day Wise");
      }
      setLoad(false);
    } catch (error) {
      console.log(error);
...
export default StudentBookIssueDayWise;
