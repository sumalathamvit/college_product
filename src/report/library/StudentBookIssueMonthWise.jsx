...
function StudentBookIssueMonthWise() {
  ...
  const handleCSVData = async (values, type) => {
    ...
    try {
      if (type == 1) {
        ...
        preFunction.downloadCSV(csvData, "Student Book Issue Month Wise");
      }
      setLoad(false);
    } catch (error) {
      console.log(error);
...
export default StudentBookIssueMonthWise;
