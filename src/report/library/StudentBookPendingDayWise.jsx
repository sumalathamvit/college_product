...
function StudentBookPendingDayWise() {
  ...
  const handleCSVData = async (values, type) => {
    try {
      ...
      if (type == 1) {
        ...
        preFunction.downloadCSV(csvData, "Student Book Pending Day Wise");
      }
      setLoad(false);
    } catch (error) {
      console.log(error);
...
export default StudentBookPendingDayWise;
