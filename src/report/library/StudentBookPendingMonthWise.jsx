...
function StudentBookPendingMonthWise() {
    ...
    try {
      ...
      if (type == 1) {
        preFunction.generatePDF(
          ...
          "Student Book Pending Month Wise",
          pdfData,
          columnWidth,
          false,
          "landscape"
        ...
        preFunction.downloadCSV(csvData, "Student Book Pending Month Wise");
      }
      setLoad(false);
    } catch (error) {
      console.log(error);
...
export default StudentBookPendingMonthWise;
