...
function StudentBookPendingWeekWise() {
    ...
    try {
      ...
      if (type == 1) {
        preFunction.generatePDF(
          ...
          "Student Book Pending Week Wise",
          pdfData,
          columnWidth,
          false,
          "landscape"
        ...
        preFunction.downloadCSV(csvData, "Student Book Pending Week Wise");
      }
      setLoad(false);
    } catch (error) {
      console.log(error);
...
export default StudentBookPendingWeekWise;
