...
function StudentBookReturnMonthWise() {
    ...
    try {
      ...
      if (type == 1) {
        ...
        preFunction.generatePDFContent(
          ...
          "Student Book Return Month Wise",
          pdfHeadToPass,
          pdfDataToPass,
          colWidthToPass,
          "Landcape"
        ...
        preFunction.downloadCSV(csvData, "Student Book Return Month Wise");
      }
      setLoad(false);
    } catch (error) {
      console.log(error);
...
export default StudentBookReturnMonthWise;
