...
function StudentBookReturnWeekWise() {
  ...
  const handleCSVData = async (values, type) => {
    try {
      ...
      if (type == 1) {
        ...
        preFunction.downloadCSV(csvData, "Student Book Return Week Wise");
      }
      setLoad(false);
    } catch (error) {
      console.log(error);
...
export default StudentBookReturnWeekWise;
