  ...
  const handleCSVData = async (values, type) => {
    try {
      ...
      if (type == 1) {
        ...
        preFunction.downloadCSV(csvData, "Title Qty Author Wise");
      }
      setLoad(false);
    } catch (error) {
      console.log(error);
...
export default TitleQtyAuthorWise;
