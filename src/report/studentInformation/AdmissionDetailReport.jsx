...
function AdmissionDetailReport() {
  ...
  const handleCSVData = async (exportData, type, values) => {
    ...
    try {
      ...
      if (type == 2) {
        ...
        var head1 = [
          [
            ...
            { content: "Admission Date", styles: topLineStyle },
          ],
        ];
      }
      ...
      if (type === 2) {
        preFunction.downloadCSV(pdfData, "Student Admission Report.csv");
      } else {
...
export default AdmissionDetailReport;
