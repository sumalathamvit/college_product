...
function StudentAddressReport() {
  ...
  const handleCSVData = async (exportData, type, values) => {
    ...
    try {
      ...
      if (type == 2) {
        ...
        var head1 = [
          [
            ...
            { content: "Temporary Address", styles: topLineStyle },
            { content: "Permanent Address", styles: topLineStyle },
          ],
        ];
      }
      ...
      if (type === 2) {
        preFunction.downloadCSV(pdfData, "Student Address Report.csv");
      } else {
        let pdfHeadToPass = [[], [...head1]];
        let pdfDataToPass = [filterContent, [...pdfData]];

        let columnWidth = [6, 10, 24, 30, 30];
                ...
                <form onSubmit={handleSubmit} autoComplete="off">
                      ...
                      <div className="row">
                        <div className="col-lg-8 p-0 pe-2">
                          <SelectFieldFormik
                            ...
                            clear={
                              collegeConfig.institution_type == 1 ? false : true
                            }
                            searchIcon={false}
                            options={courseList}
                  ...
                  <div className="row no-gutters">
                    <div className="col-lg-6 text-right pe-1">
                      <Button
                        tabIndex={collegeConfig.institution_type == 1 ? 13 : 14}
                        type="submit"
                        text="Show"
                        isCenter={false}
...
export default StudentAddressReport;
